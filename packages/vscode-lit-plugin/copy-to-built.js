...
async function main() {
	...
	await mkdirp("./built/node_modules/@bodison/ts-lit-plugin");
	...
	await writeFile("./built/node_modules/@bodison/ts-lit-plugin/package.json", JSON.stringify(tsPluginPackageJson, null, 2));
	await copy("../ts-lit-plugin/index.js", "./built/node_modules/@bodison/ts-lit-plugin/index.js");
	...
	pluginPackageJson.dependencies["@bodison/ts-lit-plugin"] = "*";
